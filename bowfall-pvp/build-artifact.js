// Builds a single-file, offline-only copy of the client (practice vs bots) at dist/bowfall-duels.html.
'use strict';
const fs = require('fs');
...
const body = part('<!--BODY-->', '<!--/BODY-->')
  .replace('<script src="sim.js"></script>', () => '<script>window.BOWFALL_OFFLINE = true;</script>\n<script>\n' + sim + '\n</script>');
