...
| Frozen Lake | Slick ice: you glide further, turn wider and slide a long way when hit, so ring-outs are easy. Water holes, snowdrifts and an ice rock. The thin ice (outlined faintly) cracks for 4 seconds and then gives way to water: the corners at 40 seconds, the top and bottom edges at 70 and the side edges at 95, so the arena shrinks as the game goes on. |
...
| Void *(new)* | A moment after a **bullseye** hit, a **rift** opens where the target lands; for 1.8s it pulls them and every enemy nearby toward its centre and slows them 30% | Event Horizon (30% bigger, stronger, 2.8s) · Collapse (rifts burst outward when they end) · Null Field (no dashing inside your rifts) · *Unstable Rift* |
| Shadow *(new)* | Hits **shroud** the target for 2.5s: darkness closes in on their screen until they can only see 170px around themselves (shrouded bots lose track of anyone further and aim worse) | Blinding Dark (shroud closes to 100px) · Creeping Dark (shrouded enemies 15% slower) · Night Terror (+20% damage to shrouded enemies) · *Lingering Dark* |
...
| --- | --- | --- | --- | --- |
| Sniper | Power | **Marksman:** arrows 10% faster and up to 20% more damage at long range; 10 less health | Railshot (Q/E) · Recoil Shot *(new)* (Q/E: next shot knocks back 40% harder and throws you backward) · Spotter's Mark *(new)* (Q/E: enemy nearest your cursor takes 30% more damage from everyone for 6s) · Steady Draw · Heavy Fletching *or* Longbow · Deadeye (more damage at range, after Longbow) · Piercing Shot · Railshot *(new)* (Q/E: next shot flies 80% faster, never slows and pierces every archer in its path) · Pin (also in the Ranger and Juggernaut trees; a full-draw hit that slams an enemy hard (380px/s or faster) into a wall or boulder within 0.45s pins them for 3s; a long slow slide doesn't count; nothing can move them while pinned, and they can't be pinned again for 4s after) · *Glass Cannon* | Ballista |
| Juggernaut | Power | **Heavyweight:** 20 more health, bigger body, 13% less knockback taken, heals 2 health a second after 4s unhurt; arrows deal 20% less damage but knock back 20% harder; 7% slower | Iron Stance (50% less knockback) · Vitality · Battering Ram · Riot Shield (head-on hits −35% damage, −30% knockback) · Deflect (Q/E: for 1s, head-on arrows bounce back at the shooter) · Bull Rush *(new)* (Q/E: half-second charge along your aim, barely moved by hits, bulldozing enemies for 12 damage and a huge shove) · Fortify *(new)* (Q/E: 3s of 70% less knockback and 30% less damage, 40% slower) · *Colossus* | Earthshaker (Q/E) |
| Ranger | Agility | **Light-footed:** 8% faster, dash recharges 20% quicker; 10 less health | Fleet Foot · Quick Dash · Double Dash · Second Wind *(new)* (Q/E: refill your dashes, 30% faster for 3s) · Seeker Arrow *(new)* (Q/E: next shot curves toward the nearest enemy ahead) · Volley (Q/E: your next shot fires three arrows in quick succession, 65% damage and knockback each) · Quickshot · Sure Footing · *Featherweight* | Grapple (Q/E) |
| Trickster | Agility | **Nimble Fingers:** draws 12% faster; arrows knock back 10% less | Ricochet · Split Arrow · Curve Shot · Switcheroo *(new)* (Q/E: if your next shot hits, swap places with the target, who keeps flying away from you) · Boomerang *(new)* (Q/E: next shot goes out through enemies and comes back, hitting them again) · Smoke Bomb *(new)* (Q/E: a smoke cloud at your cursor for 5s; anyone inside is hidden from enemies outside it, bots included) · *Scattershot* | Arrow Rain (Q/E) |
...
| Trapper | Utility | **Hunter:** abilities recharge 30% faster, +15% damage to rooted, stuck or frozen enemies | Thorned Tips · Harpoon *(new)* (Q/E: a barbed line along your aim, up to 420px, yanks the first enemy toward you and sticks them briefly) · Snare Arrow (Q/E, roots 1.8s) · Bramble Trap (Q/E, woven at your cursor up to 280px away over half a second while you move at half speed, roots 2.2s) · *Bramble Coat* | Deep Roots |
...
| Ninja *(new)* | Agility | **Shadowstep:** dash replaced by a near-instant ~150px blink the way you're moving, 2 charges usable back to back (1.5s each to recharge), crosses pits and lava; draws 20% faster; arrows only fly about 550px; 15 less health, 15% more knockback taken | Flash Strike (Q/E: blink up to 240px to your cursor, cutting enemies you pass for 12 and throwing them along your path) · Shuriken Fan (Q/E: five short-range shuriken, 6 damage each) · Caltrops (Q/E: 5s patch around you, enemies 40% slower and 5 damage a second) · Swift Shadows (blinks recharge 35% faster) · Third Step (3 blink charges) · Phase Step (arrows pass through you for 0.25s after a blink) · Flicker Draw (draw 3× faster for a moment after a blink) · *Long Step* | Shadow Dance (knockouts refill blinks and reset ability cooldowns) |
...
| Shadow | **Nightfall:** every hit also shrouds every other enemy within 220px of the target. |
...
| `CRACK_WARN`, `MAPS.lake.ice`, `MAPS.lake.cracks` | thin-ice warning time, ice slipperiness, and when each patch gives way |
